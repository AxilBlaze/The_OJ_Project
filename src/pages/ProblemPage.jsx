...
export default function ProblemPage() {
  ...
  return (
    <div style={{ background: '#18181b', minHeight: '100vh', color: '#e5e7eb', fontFamily: 'Inter, sans-serif' }}>
      {/* Header */}
      ...
      <div style={{ display: 'flex', maxWidth: 1200, margin: '2.5rem auto', gap: 32 }}>
        ...
        <div style={{ flex: 1, background: '#23232a', borderRadius: 12, padding: '2.2rem 2rem', boxShadow: '0 2px 16px #0002', display: 'flex', flexDirection: 'column', minWidth: 350 }}>
          <div style={{ fontWeight: 600, fontSize: 18, marginBottom: 10, color: '#fff' }}>Python <span style={{ fontWeight: 400, color: '#a1a1aa', fontSize: 15, marginLeft: 8 }}>(Auto)</span></div>
          <textarea
            value={code}
