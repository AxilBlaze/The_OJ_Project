            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', gap: '1rem', marginBottom: 16 }}>
                <input
                  ...
                  style={{ flex: 1, padding: '0.5rem 1rem', borderRadius: 8, border: '1px solid var(--border)', background: 'var(--bg)', color: 'var(--text)' }}
                />
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  {problems.filter(problem => {
                    ...
                    return (
                      ...
                      (problem.description && problem.description.toLowerCase().includes(q)) ||
                      (problem.tags && problem.tags.join(',').toLowerCase().includes(q))
                    );
                  }).length > 0 ? (
                    problems.filter(problem => {
                      const q = search.toLowerCase();
